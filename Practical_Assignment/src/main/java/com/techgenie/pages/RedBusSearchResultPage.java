...
public class RedBusSearchResultPage {
	...
	public void scrollTillAllItemsLoaded() {
		...
		List<WebElement> l = (List<WebElement>) jse
				.executeScript("return document.querySelectorAll(\"div[class='clearfix bus-item']\")");
		int currentItemSize = l.size();
		while (!(currentItemSize == numOfBusesfound)) {

			jse.executeScript("window.scrollBy(0,document.body.scrollHeight)");
			// ToDO we have to find a way to replace Thread.sleep(); this is a temporary
			// workaround
//				Thread.sleep(2000);
			jse.executeScript("window.scrollBy(0,document.body.scrollHeight)");
			l = (List<WebElement>) jse
					.executeScript("return document.querySelectorAll(\"div[class='clearfix bus-item']\")");
	...
	public List<WebElement> getBusDataItems(){
		List<WebElement> busItems = (List<WebElement>) jse
				.executeScript("return document.querySelectorAll(\"div[class='clearfix bus-item']\")");
		return busItems;
	}
